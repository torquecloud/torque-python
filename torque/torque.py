...
class Torque:
    ...
    @staticmethod
    def _get_torque_user_from_response_or_none(
        response: Response
    ) -> Optional[TorqueUser]:
    ...
    def verify_auth_callback_and_get_torque_user(
        ...
        torque_user = Torque._get_torque_user_from_response_or_none(response)
    ...
    def get_torque_user_if_authenticated(
        ...
        return Torque._get_torque_user_from_response_or_none(response)
